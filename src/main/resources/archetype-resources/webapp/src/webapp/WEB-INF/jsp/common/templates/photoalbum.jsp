...
<kantega:section id="content">
        ...
        <div class="index">
            <table>
                <tr>
                    <td class="previous"><photo:navigate offset="-4"><img src="<aksess:geturl url="/bitmaps/common/img_link_left.gif"/>" alt="<kantega:label key="photoalbum.group.previous" bundle="site"/>"></photo:navigate></td>
                    <photo:index width="85" height="85" max="4" cssclass="bildealbumBilde" selectedcssclass="bildealbumBildeValgt" space="4"/>
                    <td class="next"><photo:navigate offset="4"><img src="<aksess:geturl url="/bitmaps/common/img_link_right.gif"/>" alt="<kantega:label key="photoalbum.group.next" bundle="site"/>"></photo:navigate></td>
                </tr>
            </table>
        </div>
